...
// Rebounds of player with largest shoe size
...
// Winning team (most points total
function winningTeam() {
  ...
  for (let teamKey in game) {
    let players = game[teamKey].players;
    for (let player in players) {
      scores[teamKey] += players[player].points;
    }
  }
...
function doesLongNameStealATon() {
  ...
  return longestNamePlayer === maxStealsPlayer;
}
